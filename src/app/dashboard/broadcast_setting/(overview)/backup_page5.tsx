// 完成 WATI template get list name，但未 get template detail 及顯示，完成 history button

// 想完成 edit button 會變成轉跳頁面, 新增 // src/app/dashboard/broadcast_setting/[broadcast_id]/edit/page.tsx
