// 完成取得 WATI template list and detail 的功能
// 完成 schedule type debug

// 想 fix member_list 中 rowSelection 的問題
...
//       setSelectedRowKeys(newSelectedBroadcastRowKeys);
...
//         : member.member_phone, // Use member_phone as a fallback
...
//     setSelectedMembers([]); // This is fine, we reset when modal closes
