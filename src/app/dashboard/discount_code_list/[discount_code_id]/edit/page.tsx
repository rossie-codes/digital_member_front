...
const GetDiscountCodeDetailPage: React.FC = () => {
    ...
    const fetchDiscountCode = async () => {
      try {
        ...
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_API_URL}/discount_code/get_discount_code_detail/${discount_code_id}`,
          {
            method: "GET",
            headers: {
  ...
  const onFinish = async (values: any) => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/discount_code/put_discount_code_detail/${discount_code_id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleDelete = async () => {
    try {
      Modal.confirm({
        ...
        onOk: async () => {
          const response = await fetch(
            `${process.env.NEXT_PUBLIC_API_URL}/discount_code/delete_discount_code/${discount_code_id}`,
            {
              method: "PUT",
            }
          );
  ...
  const handleToggleActive = async (checked: boolean) => {
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/discount_code/put_discount_code_is_active/${discount_code_id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
        ...
        <div className="form-column">
          <Form layout="vertical">
              ...
              <>
                ...
                <Form.Item
                  ...
                  rules={[
                    {
                      required: true,
                      message: "Please enter the fixed discount cap",
                    },
                  ]}
                >
                  <InputNumber
            ...
            <Form.Item
              ...
              label="使用限制"
              rules={[
                { required: true, message: "Please select a use limit type" },
              ]}
            >
