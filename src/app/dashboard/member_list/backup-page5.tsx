// 完成新增會員 button 的 pop up window 輸入資料

// 想加入 checkbox 及 編輯 圖示於 table 的首位
// frontend 更改了顯示 membership_tier: member.membership_tier.member_tier_name || 'N/A',
...
//         membership_tier: member.membership_tier || 'N/A',
